...
\[
\frac{\partial \mathcal{L}}{\partial x} = \frac{\partial f}{\partial x} - \lambda \frac{\partial h}{\partial x} = 0
\quad\Rightarrow\quad
(\nabla f)_x = \lambda (\nabla h)_x,
\]

\[
\frac{\partial \mathcal{L}}{\partial y} = \frac{\partial f}{\partial y} - \lambda \frac{\partial h}{\partial y} = 0
\quad\Rightarrow\quad
(\nabla f)_y = \lambda (\nabla h)_y.
\]
...
\[
\frac{\partial \mathcal{L}}{\partial \lambda} = -(h(x,y)-c) = 0
\quad\Rightarrow\quad
h(x,y)=c.
\]
